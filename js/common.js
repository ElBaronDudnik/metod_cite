$(document).ready(function() {
	...
	$(".lang_menu").on('click', function() {
     ...
     $('.blogmenu-item a').on('click', function(){
     	...
     	if (!$('.left_side-blogmenu-rubrica').hasClass('initial_state')){
	     	...
	     	if (notThis.hasClass('active')){
	     		...
	     		this_item.children('.left_side-sub_blogmenu').show(500)
	     		//alert("if")
	     	}
	     	else if (this_item.hasClass('active')){
	     		this_item.children('.left_side-sub_blogmenu').hide(500);
	     		this_item.removeClass('active');
	     		$('.page_overflow').hide(500);
	     		//alert("elseif")
	     	}
	     	else{
	     		this_item.addClass('active');
     ...
     $('.header_title i.fa-search').on('click', function(){
     	...
     	$('.header_title').hide();
     	$('.search_output').show(500);
     	$('.blogmenu').hide();
     	$('.blogmenu-rubrica').hide();
     });
      $('.search_field i.fa-remove').on('click', function(){
     	$('.search_field').hide();
     	$('.header_title').show(500);
     	$('.search_output').hide();
     	$('.blogmenu').show(500);
     	$('.blogmenu-rubrica').show(500);
     })
